...
Since here are only performing a single period attribution analysis we extract just the first observation for the portfolio & bechmark. Since the package uses an end-of-period weight convention, the index of the weight data is the month-end prior to that of the return data.
