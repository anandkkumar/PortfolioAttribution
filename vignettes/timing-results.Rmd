...
This vignette gives and indication of the how long the computations take on a large data set of portfolio & benchmark weights and returns. The `system.time` command is employed.
