...
This vignette gives an indication of the how long the computations take on a large data set of portfolio & benchmark weights and returns using the built-in `system.time` command.
