...
The weights returns for portfolio & benchmark categories, the weights for the portfolio & benchmark forward contracts and the spot & forward rates for the relevant curreny pairs are extracted from the sample data sets.
...
It is important to note that the spot and forward rates data inputs need to have one more period than that of the portfolio & benchmark return data set.
...
The following command is executed to perform attribution analysis with currency effects on this data set using the Ankrim and Hensel methodology.
